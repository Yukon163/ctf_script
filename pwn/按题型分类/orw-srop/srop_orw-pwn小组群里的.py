...
readFrame.rip = call_syscall
readFrame.sp = buf_addr + 8 + 8 + 8 + 8 + 248 + 8 + 8 + 8 + 248
...
writeFrame.rip = call_syscall
writeFrame.sp = buf_addr + 8 + 8 + 8 + 8 + 248 + 8 + 8 + 8 + 248 + 8 + 8 + 8 + 248
